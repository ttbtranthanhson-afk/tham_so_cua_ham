...
const slideStepsCount = {
    1: 8, // 0 to 8
    2: 14, // 0→problem card, 1-3 hàm explain, 4 trace start, 5-11 loop, 12-14 main program
    3: 14, // 0→problem card, 1-2 hàm explain, 3-10 trace, 11-13 main program, 14 tổng kết
    4: 1
};
